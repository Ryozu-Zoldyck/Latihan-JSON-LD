        ...
        <div class="uk-navbar-left">
            <ul class="uk-navbar-nav">
                ...
                if (empty($_SESSION["username"])) {
                    ...
                    echo "<li><a href='sparepart.php' style='color:white;'>Sparepart</a></li>";
                }
                ?>
            </ul>
        </div>
    ...
    <center>
        <div class="uk-container" style="padding-top:30px">
            ...
            <div class="uk-tile uk-tile-muted">
                <p class="uk-h5" style="font-family:rockwell;">BENGKELKU merupakan sistem reservasi jadwal service motor
                    berbasis web.<br></p>

                <p align=left class="uk-h5" style="font-family:rockwell; padding-left:80px;">Cara melakukan reservasi
                    jadwal service cukup mudah :
