...
<body>
    ...
    <nav class="uk-navbar-container" style="background-color:rgb(30,135,240);" uk-navbar>
        <div class="uk-navbar-left">
            <ul class="uk-navbar-nav">
                <li class="uk-active"><a href="index.php"
                        style="color:white; padding:30px; font-size: 40px;font-family:rockwell;">Ryozu Racing Team</a></li>
                </li>
                <?php
    ...
    <div class="uk-container" style="padding-top:25px;">
        ...
        <div class="uk-container">
            <form class="uk-form-stacked" action="action/act_daftar.php" method="post">
                <div class="uk-margin">
                    <label class="uk-form-label" for="form-stacked-text">Username</label>
                    <div class="uk-form-controls">
                        <input class="uk-input" id="form-stacked-text" type="text" name="username"
                            placeholder="Masukkan Username" maxlength="15" required>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="form-stacked-text" type="password" name="password"
                            placeholder="Masukkan Password" autocomplete="off" maxlength="15" required>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="form-stacked-text" type="text" name="nama"
                            placeholder="Masukkan Nama Lengkap" maxlength="30" required>
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="form-stacked-text" type="date" name="tgl_lahir" min='1910-01-01'
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="form-stacked-text" type="number" name="no_telp" maxlength="15"
                ...
                <div class="uk-margin">
                    ...
                    <textarea class="uk-textarea" rows="3" name="alamat" maxlength="50" placeholder="Masukkan Alamat"
                        required></textarea>
                </div>

                <button class="uk-button uk-button-primary" type="submit" name="button">DAFTAR</button>
