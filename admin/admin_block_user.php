    ...
    <nav class="uk-navbar-container" style="background-color:rgb(30,135,240);" uk-navbar>
        <div class="uk-navbar-left">
            <ul class="uk-navbar-nav">
                <li class="uk-active"><a href="admin_index.php"
                            ...
                            <center>
                                <form class="uk-form-stacked" action="#" method="POST" autocomplete="off">
                                    <div class="uk-form-controls">
                                        Cari User :
                                        <input class="uk-input uk-form-width-small" id="form-stacked-text" type="text"
                                            name="username" placeholder="Masukkan Username" required>
                                        <button class="uk-button uk-button-primary" type="submit"
                                            name="button">Cari</button>
                                    </div>
                                </form>
                                <br>
                                <form class="uk-form-stacked" action="#" method="POST" autocomplete="off">
                ...
                <tbody>
                    ...
                    foreach ($data as $baris) { ?>
                        <tr>
                            <td>
                                <center><a
                                        href='admin_profil_user.php?username=<?php echo $baris['username'] ?>'><?php echo $baris['username'] ?></a>
                                </center>
                            </td>
                            <td>
                                <center><?php echo $baris['nama'] ?></center>
                            </td>
                            <td>
                                <center><?php echo $baris['block'] ?></center>
                            </td>
                            <td>
                                <center>
                                    <?php
                                    if ($baris['block'] == "Tidak") { ?>
                                        <a class="uk-button uk-button-danger"
                                            href="action/act_block_user_admin.php?username=<?php echo $baris['username'] ?>">Block</a>
                                    <?php }
                                    if ($baris['block'] == "Ya") { ?>
                                        <a class="uk-button uk-button-primary"
                                            href="action/act_unblock_user_admin.php?username=<?php echo $baris['username'] ?>">Unblock</a>
                                    <?php }
                                    ?>
                                </center>
                            </td>
