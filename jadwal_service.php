        ...
        <div class="uk-navbar-left">
            <ul class="uk-navbar-nav">
                <li class="uk-active"><a href="index.php"
                        style="color:white; padding:30px; font-size: 40px;font-family:rockwell;">Ryozu Racing Team</a>
                </li>
                </li>
                <?php
    ...
    <div class="uk-container" style="padding-top:25px;">
        ...
        <div class="uk-container">
            <div class="uk-margin">
                <form class="uk-form-stacked" action="#" method="POST" <?php if (isset($_POST['tanggal'])) {
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <input class="uk-input" id="form-stacked-text" type="date" name="tanggal"
                                min="<?php echo date('Y-m-d', strtotime('+1 day')); ?>"
                                max="<?php echo date('Y-m-d', strtotime('+7 day')); ?>" required>
                        </div>
                    </div>
                    <?php
                ...
                <form class="uk-form-stacked" action="#" method="POST" <?php
                if (isset($_POST['tanggal'])) {
                } else {
                    echo "hidden";
                } ?>>
                    ...
                    <label class="uk-form-label" for="form-stacked-text" style="color:grey">0 - 5 (kosong -
                        penuh)</label>
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <input class="uk-input" id="form-stacked-text" type="date" name="tanggal"
                                min="<?php echo date('Y-m-d', strtotime('+1 day')); ?>"
                                max="<?php echo date('Y-m-d', strtotime('+7 day')); ?>" value="<?php if (isset($_POST['tanggal'])) {
                                        echo $_POST['tanggal'];
                                    } else {
                                        echo '';
                                    } ?>" required>
